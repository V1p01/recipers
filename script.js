...
const recipesData = [
    ...
    },
    {
        ...
        ingredients: [
            'Гречка - 1 стакан - 40₽',
            'Мясо (свинина/говядина) - 300 г - 250₽',
            'Лук - 2 шт - 20₽',
            'Морковь - 1 шт - 15₽',
    ...
    },
    {
        ...
        difficulty: 'Легко',
        category: 'dinner',
        description: 'Классические макароны с сыром по-студенчески',
        ingredients: [
            'Макароны - 250 г - 45₽',
            'Сыр - 150 г - 90₽',
            'Молоко - 100 мл - 10₽',
    ...
    return `
        <div class="recipe-card" data-category="${recipe.category}">
            ...
            <div class="recipe-content">
                ...
                <button class="recipe-btn" onclick="openRecipe('${recipe.id}')">Подробнее</button>
            </div>
        </div>
    `;
}
...
function loadRecipes() {
    ...
    grid.innerHTML = recipesData.map(recipe => createRecipeCard(recipe)).join('');
}
